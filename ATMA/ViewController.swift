...
class ViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    private var didRequestPush = false
    ...
    private func setupWebView() {
        ...
        // UA-маркер ATMAiOS — его также ловит ios-compat.js
        webView.customUserAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1 ATMAiOS"
    ...
    // Keep vatma.ru inside the app, open everything else in Safari.
